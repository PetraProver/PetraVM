...
macro_rules! impl_immediate_binary_operation {
    ($t:ty) => {
        ...
        impl $crate::event::model::ImmediateBinaryOperation for $t {
            fn new(
                timestamp: u32,
                pc: BinaryField32b,
                fp: u32,
...
macro_rules! impl_binary_operation {
    ($t:ty) => {
        ...
        impl $crate::event::model::NonImmediateBinaryOperation for $t {
            fn new(
                timestamp: u32,
                pc: BinaryField32b,
                fp: u32,
...
macro_rules! impl_left_right_output_for_imm_bin_op {
    ($t:ty) => {
        impl $crate::event::model::LeftOp for $t {
        ...
        impl $crate::event::model::OutputOp for $t {
