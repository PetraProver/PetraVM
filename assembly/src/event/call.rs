...
impl TailiEvent {
    ...
    pub fn generate_event(
        ...
        interpreter.set_value(trace, interpreter.fp ^ next_fp.val() as u32, next_fp_val)?;
        ...
        interpreter.set_value(trace, next_fp_val, return_addr)?;
        interpreter.set_value(trace, next_fp_val + 1, old_fp_val)?;
...
impl TailVEvent {
    ...
    pub fn generate_event(
        ...
        interpreter.set_value(trace, next_fp_addr, next_fp_val)?;
