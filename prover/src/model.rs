...
impl Trace {
        ...
        I: IntoIterator<Item = InterpreterInstruction>,
    {
        ...
        // TODO: we need to add a instruction with multiplicity 0 due to a bug in lookup gadget
        // which requires a minimum number of instructions
        instructions_with_counts.push((Instruction {
            pc: B32::new(0),
            opcode: Opcode::Bnz,
            args: vec![],
        }, 0));
