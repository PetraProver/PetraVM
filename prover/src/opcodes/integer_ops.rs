...
use petravm_asm::{opcodes::Opcode, AddEvent, AddiEvent, MuluEvent, SubEvent};
...
mod tests {
    ...
    /// Creates an execution trace for a simple program that uses SUB, ADD and
    /// MULU instructions.
    fn generate_vrom_integer_ops_trace(src1_value: u32, src2_value: u32) -> Result<Trace> {
        ...
        let vrom_writes = vec![
            ...
            // MULU events
            (8, mulu_result_array[0], 1),
            (9, mulu_result_array[1], 1),
        ];
